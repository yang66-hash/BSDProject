...
@Data
public class FallingDominoesContext extends ParentContext {

    //时间间隔
    private Integer metricsInterval;
    //当前时间间隔内
    @Schema(description = "统计该服务的每一个实例是否涉及到Falling Dominoes异味")
    private Map<String, FallingDominoesItem> instanceStatus;
